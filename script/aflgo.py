...
class LAVA1:
    ...
    # ----------------------------------------------------------------------
    def __init__(self, compile_flag="gcc", recalculate=False, force_rebuild=False, target_extend_num=3,
    ...
    def _set_targets_item(self):
        ...
        if self.compiler_flag == "aflgo_get":
            for item in self.branches:
                ...
                if not os.path.exists(file_output_item_checkfile_path) or os.path.getsize(
                        file_output_item_checkfile_path) == 0:
                    continue
...
if __name__ == '__main__':
    ...
    special_target = [
        "file-5.22.1460_KT_0xda897fff"]  # ["file-5.22.16830_R_0x12345678-0x123456f8"] # "file-5.22.292_R_0x12345678-0x12545678"

    lava1 = LAVA1(force_rebuild=force_rebuild, recalculate=recalculate,
                  target_extend_num=target_extend_num, target_source_line=target_source_line,
